...
function Footer() {
  const data = [
    ...
    },
    {
      id: 2,
      trending_locations: [
        { id: 1, data: "bhubaneshwar" },
        { id: 2, data: "hyderabad" },
        { id: 3, data: "chandigarh" },
        { id: 4, data: "nashik" },
      ],
    },
    { id: 3, about_us: [{ id: 1, data: "contact us" }] },
    {
      id: 4,
      olx: [
        { id: 1, data: "help" },
        { id: 2, data: "sitemap" },
        { id: 3, data: "legal & privacy information" },
        { id: 4, data: "vulnerability disclosure program" },
      ],
    },
  ];

  return (
    <div className=" bg-[#e3e2e2] sticky  w-full">
      <div className="flex justify-between max-w-7xl mx-auto p-3">
        <div>
          <h3 className="font-bold text-sm">POPULAR LOCATIONS</h3>
          {data[0].popular_locations.map((item) => {
            return (
              <p className="text-[12px] my-2 capitalize text-[#727272]" key={item.id}>
                {item.data}
              </p>
            );
          })}
        ...
        <div>
          <h3 className="font-bold text-sm">TRENDING LOCATIONS</h3>
          {data[1].trending_locations.map((item) => {
            return (
              <p className="text-[12px] my-2 capitalize text-[#727272]" key={item.id}>
                {item.data}
              </p>
        ...
        <div>
          <h3 className="font-bold text-sm">OLX</h3>
          {data[3].olx.map((item) => {
            return (
              <p className="text-[12px] my-2 capitalize text-[#727272]" key={item.id}>
                {item.data}
        ...
        <div>
          ...
          <div className=" inline-block mr-2 ">
            <svg width="26px" height="26px" viewBox="0 0 1024 1024" fill="#002f34a3" data-aut-id="icon" class="" fill-rule="evenodd">
      ...
      <div className="bg-[#002f34] h-14"></div>
    </div>
  );
}
